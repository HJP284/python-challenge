...
#set path for file
budget_data_csv = os.path.join("C:\\Users\\hjp28\\Desktop\\Resource\\budget_data.csv")
...
for files in budget_data_csv:
    ...
    with open(budget_data_csv) as csvFile:
        ...
        for line in csvReader:
            ...
            # change in revenue between this month and last month
            ...
            # is change in revenue is a max or min for data set thus far
        ...
        # Name white file
        output_file = budget_data_csv[0:-4]
